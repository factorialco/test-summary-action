...
exports.generateCypressTestSummary = void 0;
const generateCypressTestSummary = (reportData) => __awaiter(void 0, void 0, void 0, function* () {
    const testsData = reportData.results
        .flatMap(({ fullFile, suites }) => suites.flatMap(({ title: suiteTitle, tests }) => tests.map(({ title, fail }) => fail ? [fullFile, suiteTitle, title, 'TODO'] : null)))
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let table;
            if (engine === 'cypress') {
                table = yield (0, cypress_1.generateCypressTestSummary)(reportData);
            }
            else {
